# TODO: this is a hue -> backproject -> camshift method on hue with kalman filter (filter tracks box points from camshift
# For reference for kalman filter. aglo i do not like but kalman may be useful if we wind up incorporating other data sources
# might try to tweak for hsv ranges you found good in other script or try detecting a color then filter on that color
#####################################################################
...
# camera_to_use = 'C:/Users/phahn/Desktop/videoplayback.avi'
...
cap = cv2.VideoCapture('C:/Users/phahn/Desktop/broheim.mp4');
